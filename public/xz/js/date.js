...
//            getAppCondtion();
        ...
        $(".ui-datepicker-quick input").on("click",function(){
            ...
            $(".ui-datepicker-time span").text(dateList);
...
$(function(){
		...
		$(".ui-datepicker-time span").text(endDateStr +"—"+ timeStr)
		$('.startd').html(endDateStr);
		$('.endd').html(timeStr);
    ...
    function datePickers(){
        ...
        $(".ui-datepicker-time span").html(dateList);
        $(".ui-datepicker-css").css("display","none");
//        getAppCondtion()
    }